<div class="modal fade" id="subirPresentacionModal" tabindex="-1" aria-labelledby="subirPresentacionModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(route('eventos.guardarPresentacion', $evento->id)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\xampp\htdocs\presentador-laravel\resources\views/includes/popups/subir-presentacion.blade.php ENDPATH**/ ?>