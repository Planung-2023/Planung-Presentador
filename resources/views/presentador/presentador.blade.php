...
<html lang="en">
    ...
    <body>
        <nav class="navbar d-flex align-items-center justify-content-center bg-dark navbar-expand-lg bd-navbar fixed-top">
            <div id="estado-presentacion" class="d-flex align-items-center justify-content-center">
                <div id="contenedor-estado"class="bg-secondary p-2 rounded">
