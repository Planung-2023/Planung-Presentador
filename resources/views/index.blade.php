                ...
                <tbody>
                    @foreach ($eventos as $evento)
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-secondary" style='margin-right:4px' onclick='console.log("ID del Evento:", {{ $evento->id }}); abrirModalConEvento({{ $evento->id }})'>Subir Presentaciones</button>
                                
                                @if ($evento->cantidad_presentaciones > 0)
                                    <button class="btn btn-secondary" type="button" onclick="mostrarPresentacionesModal({{ $evento->id }})">Ver Presentaciones</button>
                                @else
